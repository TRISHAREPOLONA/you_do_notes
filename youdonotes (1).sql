...
INSERT INTO `products` (`id`, `title`, `description`, `price`, `seller_email`, `course`, `file_path`, `note_link`) VALUES
...
(2, 'Systems Analysis Notes', 'Key concepts and diagrams for system analysis and design.', 75.00, 'admin@youdo.com', 'BSIS', 'uploads/notes/sa_notes.pdf', NULL),
(3, 'Networking Fundamentals', 'Covers OSI model, subnetting, and basic protocols.', 60.00, 'admin@youdo.com', 'BSIT', 'uploads/notes/networking.pdf', NULL),
(4, 'Web Development Cheat Sheet', 'HTML, CSS, and JS essentials for IT students.', 50.00, 'admin@youdo.com', 'BSIT', 'uploads/notes/WebDev.pdf', NULL),
(5, 'Data Structures & Algorithms', 'Summaries of sorting, searching, and complexity analysis.', 100.00, 'admin@youdo.com', 'BSCS', 'uploads/notes/dsa_notes.pdf', NULL),
...
(7, 'Anatomy & Physiology Reviewer', 'Essential body systems with diagrams.', 90.00, 'admin@youdo.com', 'BSNURSING', 'uploads/notes/anatomy.pdf', NULL),
(8, 'Pharmacology Notes', 'Drug classifications, dosages, and nursing responsibilities.', 110.00, 'admin@youdo.com', 'BSNURSING', 'uploads/notes/pharmacology.pdf', NULL),
...
(10, 'Power Systems Reviewer', 'Generation, transmission, and distribution concepts.', 95.00, 'admin@youdo.com', 'BSELECTRICALTECH', 'https://docs.google.com/document/d/1HGKTa69buN0MbHRgJ47c857GCo-XqlFmtCczEB7OHo0/edit?usp=sharing', NULL),
(11, 'Educational Psychology Notes', 'Learning theories and classroom applications.', 65.00, 'admin@youdo.com', 'BSEDUC', 'uploads/notes/psychology.pdf', NULL),
(12, 'Curriculum Development Reviewer', 'Frameworks and models for designing effective curriculum.', 85.00, 'admin@youdo.com', 'BSEDUC', 'https://docs.google.com/document/d/1kOmnSs4qEw8DrVFMJNgq-FNmvjwuqaOGDFdRbvI0VRM/edit?usp=sharing', NULL),
(13, 'SAMPLE', 'This is just a Sample upload, no need to Download it', 0.00, 'guest@bicol-u.edu.ph', '', 'https://docs.google.com/document/d/1PEKgFF4PvkQqRbhaFeBs9He3l4HWLF74Ujp1LWYclIA/edit?usp=sharing', ''),
(14, 'Kunwari', 'This is an example ', 100.00, 'buds@bicol-u.edu.ph', '', 'uploads/notes/platform_modification_Villanueva_Ondis_Repolona_Honradez.pdf', NULL),
(16, 'Mama mo blue', 'Activity siya basta ', 150.00, 'cjo@bicol-u.edu.ph', '', 'https://docs.google.com/document/d/1-cTafewaGpTUy7rJlktn6DGXT4q3kqpn6Jy86iO0rcc/edit?usp=sharing', NULL);
